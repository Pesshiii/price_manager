...
class SettingForm(forms.ModelForm):
  ...
  create_new = forms.ChoiceField(
    label='Добавлять новые товары в ПП:',
    required=False, 
      ...
      HTML('''
        <div class="row p-2">
          <ul>
            ...
            <li>В случае если внутри файла есть дубликаты, данные беруться только из одного(первого по порядку) ряда, об этом придёт предупреждение</li>
