...
class SupplierProductFilter(FilterSet):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.form.helper.layout = Layout(
      ...
      Div(
        Div(Field('stock_min'), Field('stock_max'), css_class='col-md-6 d-flex flex-column gap-2'),
        Div(Field('supplier_price_min'), Field('supplier_price_max'), css_class='col-md-6 d-flex flex-column gap-2'),
        Div(Field('rrp_min'), Field('rrp_max'), css_class='col-md-6 d-flex flex-column gap-2'),
        Div(Field('discount_price_min'), Field('discount_price_max'), css_class='col-md-6 d-flex flex-column gap-2'),
