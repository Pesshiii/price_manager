...
urlpatterns = [
    ...
    path('products/pim-image/<str:file_id>/<str:size>/', product_views.PimImageView.as_view(),
         name='pim-image'),
    ...
    path('shopping-tabs/<int:pk>/export/', views.ShoppingTabExportView.as_view(), name='shopping-tab-export'),
    path('shopping-tabs/exports/<int:pk>/download/', views.ShoppingTabExportDownloadView.as_view(), name='shopping-tab-export-download'),
    path('shopping-tabs/<int:pk>/import/', views.ShoppingTabImportView.as_view(), name='shopping-tab-import'),
    path('shopping-tabs/<int:pk>/import/preview/', views.ShoppingTabImportPreviewView.as_view(), name='shopping-tab-import-preview'),
